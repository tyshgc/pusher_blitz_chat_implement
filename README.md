...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/pusher_blitz_chat_implement
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/pusher_blitz_chat_implement_test
```
